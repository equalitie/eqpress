...
?>
						<div class="postbox">
							<h3><span>About the easyPress Console</span></h3>
							<div class="inside">
								<p>The easyPress Console allows you to perform some administrative tasks that otherwise would require shell access.</p>
							</div>
						</div> <!-- .postbox -->
<?php
					}
				...
				<div class="meta-box-sortables ui-sortable">
					<div class="postbox">
						...
						<div class="inside">
							...
							<p>Please note that if you enable SSL you will be using the easyPress SSL certificates therefore you will encounter SSL warnings the first time you visit your admin screens. You can read more about the warnings you will encounter on the easyPress help page titled <a href="http://easypress.ca/security-warning-for-wp-admin-and-ssl-certificates/" target="_blank" title="Security warning for wp-admin and SSL certificates">Security warning for wp-admin and SSL certificates.</a> If you have your own SSL certificates please get in touch with <a href="mailto:support@easypress.ca">easyPress Support</a> and we will install them for you.</p>

...
class The_Console {
	...
	static function add_sidebar_menu() {
		...
		add_menu_page( 'The Console', 'Console', 'manage_options', 'ep_dashboard', array( __CLASS__, 'eqpress_console_mainpage' ), 'dashicons-desktop', 1 );
		
		add_submenu_page( 'ep_dashboard', 'The Console - Overview', 'Overview', 'manage_options', 'ep_dashboard' );

		add_submenu_page( 'ep_dashboard', 'The Console - Website Stats', 'Website Stats', 'manage_options', 'ep_webstats', array( __CLASS__, 'eqpress_console_webstats' ) );
		
		add_submenu_page( 'ep_dashboard', 'The Console - Manage Cache', 'Manage Cache', 'manage_options', 'ep_cache', array( __CLASS__, 'eqpress_console_cache' ) );
		
		add_submenu_page( 'ep_dashboard', 'The Console - Logs', 'View Logs', 'manage_options', 'ep_logs', array( __CLASS__, 'eqpress_console_logs' ) );
		
		add_submenu_page( 'ep_dashboard', 'The Console - Permissions', 'File Permissions', 'manage_options', 'ep_perms', array( __CLASS__, 'eqpress_console_perms' ) );
		
		add_submenu_page( 'ep_dashboard', 'The Console - Lockdown', 'Security Lockdown', 'manage_options', 'ep_lockdown', array( __CLASS__, 'eqpress_console_lockdown' ) );
		
		add_submenu_page( 'ep_dashboard', 'The Console - Reset Password', 'Reset Password', 'manage_options', 'ep_sftp', array( __CLASS__, 'eqpress_console_sftp_stuff' ) );
		
		add_submenu_page( 'ep_dashboard', 'The Console - Administration Over SSL', 'Admin Over SSL', 'manage_options', 'ep_ssl', array( __CLASS__, 'eqpress_console_wpadmin_ssl' ) );
		
		add_submenu_page( 'ep_dashboard', 'The Console - Plugin and Theme Editor', 'Code Editor', 'manage_options', 'ep_editor', array( __CLASS__, 'eqpress_console_editor' ) );

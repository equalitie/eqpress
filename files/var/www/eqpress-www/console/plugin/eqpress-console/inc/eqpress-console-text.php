					...
					<div class="postbox">
						...
						<div class="inside">
							...
							<ol>
								...
								<li><strong>Web server access log</strong> - contains a record of every file transferred from your site.</li>
			...
			<div id="post-body-content">
				<div class="meta-box-sortables ui-sortable">
					<div class="postbox">
						...
						<div class="inside">
							<p>The File Permissions feature allows you to reset the permissions and ownership on your files back to the default settings. The reason you might need to do this is if you upload or install a plugin manually and then that plugin requires write access to function properly. The issue is that your SFTP username is not the same as the web server's user name, so when you upload files into your document root you do so as your SFTP username. Therefore, when the plugin tries to write to a file or directory that is owned by your SFTP username and not the web server's username, it will fail because of insufficient ownership and permissions on those files. The button in the File Permissions page will reset all directories and files under your document root to be owned by the web server user.</p>
			...
			<div id="post-body-content">
				<div class="meta-box-sortables ui-sortable">
					<div class="postbox">
						...
						<div class="inside">
							<p>The Security Lockdown feature allows you to change the ownership and permissions on all the files and directories under your document root to be owned by your SFTP username. When you choose to lock down your site, none of your files will be owned by the web server's user, which effectively prevents it from writing to any of your files or directories. This creates a very secure environment, since access to your public site is via the web server and by disallowing the web server from having write access, you are protecting yourself against any potential hacks that work by creating or downloading new files within your document root.</p>
			...
			<div id="post-body-content">
				<div class="meta-box-sortables ui-sortable">
					<div class="postbox">
						...
						<div class="inside">
							<p>SSL provides confidentiality between your browser and the web server. By encrypting the communication between you and the server, you are making it very difficult for malicious hackers to steal your private information. If you use SSL, credentials such as usernames and passwords will be undecipherable if they were to be intercepted while in transit. Same with your authentication tokens such as the cookies which are sent every time you view or make changes via the admin screens.</p>
							<p>There are 3 choices when configuring WordPress to use SSL:
							<ol>
								<li>Enable SSL for login and all admin screens.</li>	
								<li>Enable SSL for logging in only.</li>	
								<li>Disable SSL.</li>	
							</ol></p>
							<p>Please note that if you enable SSL, you will be using our SSL certificates and therefore you will encounter SSL warnings the first time you visit your admin screens. If you have your own SSL certificates, please get in touch with the eQPress team through the Dashboard and we will install them for you.</p>
				...
				<div class="meta-box-sortables ui-sortable">
					<div class="postbox">
						...
						<div class="inside">
							...
							<p>Read more about <a href="http://codex.wordpress.org/Editing_wp-config.php#Disable_the_Plugin_and_Theme_Editor" target="_blank" title=" Disable the Plugin and Theme Editor"> Disabling the Plugin and Theme Editor</a> on the WordPress Codex</p>	
					</div> <!-- .inside -->
					</div> <!-- .postbox -->
				</div> <!-- .meta-box-sortables .ui-sortable -->
			</div> <!-- post-body-content -->
